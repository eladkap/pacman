function findPathAux(mat, src_pos_i, src_pos_j, dest_pos_i, dest_pos_j, path){
  ...
  // go right
  if (findPathAux(mat, src_pos_i, src_pos_j + 1, dest_pos_i, dest_pos_j, path)){
    return true;
  }

  // go up
  if (findPathAux(mat, src_pos_i - 1, src_pos_j, dest_pos_i, dest_pos_j, path)){
    return true;
  }
...
function findPath(mat, src_pos_i, src_pos_j, dest_pos_i, dest_pos_j){
  var path = [];
  var result = findPathAux(mat, src_pos_i, src_pos_j, dest_pos_i, dest_pos_j, path);
  // console.log(result);
  if (!result){
    return [];
  }
